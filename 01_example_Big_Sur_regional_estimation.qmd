...
The coefficient of variation (the SE scaled as percent of the mean) is `r round(100*(sqrt(Vtr)/Tr_hat), 1)`%, which is significantly higher than the coeffient of variation for density, `r round(100*(sqrt(Vdw)/Dw_hat), 1)`%. This is a typical and inevitable feature of estimating totals versus densities, arising from equation 33 in FB182. 
